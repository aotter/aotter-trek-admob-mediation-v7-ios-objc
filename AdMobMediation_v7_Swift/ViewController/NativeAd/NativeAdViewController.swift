...
class NativeAdViewController: UIViewController {
    ...
    private let googleMediationNativeAdPosition: Int = 6
    
    private var refreshControl: UIRefreshControl?
    
    private var adLoader: GADAdLoader?
    private var gADUnifiedNativeAd: GADUnifiedNativeAd?
...
extension NativeAdViewController {
    ...
    private func setupGADAdloader() {
        ...
        adLoader = GADAdLoader.init(adUnitID: TestNativeAdUnit, rootViewController: self, adTypes: [.unifiedNative], options: [])
...
extension NativeAdViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == googleMediationNativeAdPosition {
            ...
            trekNativeAdTableViewCell.setGADUnifiedNativeAdData(nativeAd: gADUnifiedNativeAd )
