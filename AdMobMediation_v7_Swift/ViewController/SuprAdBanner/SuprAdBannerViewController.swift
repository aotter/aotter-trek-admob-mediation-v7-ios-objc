...
class SuprAdBannerViewController: UIViewController {
    ...
    private var gADUnifiedSuprAd_BottomBanner: GADUnifiedNativeAd?
...
extension SuprAdBannerViewController {
    ...
    private func setupGADAdloader() {
        ...
        adLoader = GADAdLoader.init(adUnitID: TestSuprAdUnit_BottomBanner, rootViewController: self, adTypes: [.unifiedNative], options: [])
...
extension SuprAdBannerViewController: GADUnifiedNativeAdLoaderDelegate {
...
extension SuprAdBannerViewController {
    private func setupSuprAdBackgroundView(nativeAd:GADUnifiedNativeAd?, size:CGSize) {
