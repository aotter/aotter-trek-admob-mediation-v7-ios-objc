...
@interface SuprAdBannerViewController ()<GADUnifiedNativeAdLoaderDelegate>
@property (weak, nonatomic) IBOutlet UIButton *refreshButton;
@property (atomic, strong) GADAdLoader *adLoader;
@property (nonatomic, strong) GADUnifiedNativeAd *gADUnifiedSuprAd_BottomBanner;
...
- (void)setupSuprAdBackgroundView:(GADUnifiedNativeAd *)nativeAd preferedMediaViewSize:(CGSize)size {
